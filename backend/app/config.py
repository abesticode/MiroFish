...
if os.path.exists(project_root_env):
    ...
    # If there is no .env in the root directory, try to load environment variables (for production environments)
...
class Config:
    ...
    # JSON configuration - disable ASCII escaping and let Chinese display directly (instead of \uXXXX format)
    JSON_AS_ASCII = False
    ...
    # Action configuration available on the OASIS platform
