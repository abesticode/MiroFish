...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are an expert in generating social media user portraits. Generate detailed and realistic personas for public opinion simulation, and restore existing reality to the greatest extent. Valid JSON format must be returned, and all string values ​​cannot contain unescaped newlines."
...
- {get_language_instruction()} (gender field must be in English male/female)
...
- {get_language_instruction()} (gender field must be in English "other")
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        with open(file_path, 'w', newline='', encoding='utf-8') as f:
            ...
            for idx, profile in enumerate(profiles):
                # user_char: complete persona (bio + persona), used for LLM system prompts
