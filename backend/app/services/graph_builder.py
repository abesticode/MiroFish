...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Zep is a reserved name and cannot be used as an attribute name.
    ...
    def add_text_batches(
        ...
        """Add text to the graph in batches and return the uuid list of all episodes"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to be processed (by querying the processed status of each episode)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Get complete map data (including detailed information)
        
        Args:
            graph_id: graph ID
            
        Returns:
            A dictionary containing nodes and edges, including time information, attributes and other detailed data
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
