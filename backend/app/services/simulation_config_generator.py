...
- **Time conforms to the schedule of the target user group**: The following is a reference (Dongba District), please adjust according to the simulation scenario
...
{{
    "agent_configs": [
        ...
        system_prompt = "You are an expert in social media behavior analysis. Return pure JSON, and the configuration must conform to the work and rest habits of the target user group in the simulation scenario."
