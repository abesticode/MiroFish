...
class LLMClient:
    ...
    def chat(
        ...
        # Some models (such as MiniMax M2.5) will contain <think> thinking content in the content and need to be removed.
    ...
    def chat_json(
        ...
        try:
            ...
            raise ValueError(f"The JSON format returned by LLM is invalid: {cleaned_response}")
