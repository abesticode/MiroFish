    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">millions of Agents</span> based on real-world seeds. Inject variables from a god's-eye view and find the <span class="highlight-code">"local optimum"</span> in complex group interactions within dynamic environments.
            </p>
            <p class="slogan-text">
              Let the future play out among Agents — let decisions win after a thousand simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby — upload one or more unstructured files to initialize the simulation sequence
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction requirements & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction in natural language (e.g. If Wuhan University publishes an announcement revoking Xiao's disciplinary action, what public opinion trends will emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
.console-divider::after { content: ''; flex: 1; height: 1px; background: #EEE; }
